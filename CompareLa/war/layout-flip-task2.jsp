...
<div align="right">
	...
	<div id="task2a">
		<table text-align="left" width="45%" style="font-size:14px;">
			...
			<tr width="80%"><td></td><td>
				...
				<tr><td>Top 1</td><td>Ralph Lauren Blue</td></tr>
				<tr><td>Top 2</td><td>Ralph Lauren Black</td></tr>
				</table>
			</td></tr>
	...
	<div class="task2b" id="task2b">
		<table text-align="left" width="45%" style="font-size:14px;">
			...
			<br>Choose the better product out of the 2 based on ONLY <b>location</b> and <b>stock</b> as the comparison criteria.</td></tr>
		</table>
		<br><br>
		<table text-align="left" width="45%" style="font-size:14px;">
			...
			<form action="processTask">
				...
				<input type="radio" name="answer" value="ralph_lauren_blue" checked>Ralph Lauren Blue
				<input type="radio" name="answer" value="ralph_lauren_black">Ralph Lauren Black
