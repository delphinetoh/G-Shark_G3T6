...
<div align="right">
	...
	<div id="task3a">
		<table text-align="left" width="45%" style="font-size:14px;">
			...
			<tr width="80%"><td></td><td>
				...
				<tr><td>Top 1</td><td>Cheap Monday Shirt</td></tr>
				<tr><td>Top 2</td><td>Cheap Monday Monochrome</td></tr>
				</table>
			</td></tr>
	...
	<div class="task3b" id="task3b">
		<table text-align="left" width="45%" style="font-size:14px;">
			...
			<br>Choose the better product out of the 2 based on ONLY <b>stock</b> and <b>likes</b> as the comparison criteria.</td></tr>
		</table>
		<br><br>
		<table text-align="left" width="45%" style="font-size:14px;">
			<tr><td width="100%"><h2>So what's your answer?</h2></td><td width="20%"></td></tr>
			<tr><td>
			<form action="processTask">
				...
				<input type="radio" name="answer" value="cheap_monday_shirt" checked>Cheap Monday Shirt
				<input type="radio" name="answer" value="cheap_monday_monochrome">Cheap Monday Monochrome
