...
function compare()
{
	...
	if (($('#img1').attr("src")== "../images/question_mark.png") || ($('#img2').attr("src")== "../images/question_mark.png")) {
		...
		$("<div class='ui-loader ui-overlay-shadow ui-body-e ui-corner-all'>You must have 2 items in the comparator!</div>")
...
<div data-role="header" data-position="inline" data-position="fixed">
  ...
  <div data-role="footer" data-position="fixed">
	...
	<!-- <fieldset id="any" class="ui-grid-c"> -->
          	...
          	<div class="ui-block-a" style="margin-top: 0em;margin-left: 1.2em; display:block;" >
				 <img id="img1" img alt="" src="../images/question_mark.png" border="0" style="height: 150px;" />
				 <div id="name1" style="font-size:12px;float: left ;"></div>
          	</div>

 			<div class="ui-block-b" width="50px">
 					...
 					<image src="../images/delete.png" onclick="removeFirst()" class="ui-btn ui-shadow ui-corner-all ui-icon-plus ui-btn-icon-notext" style="right:17px; bottom:4px; width:35%;height:35%;" />
 					<!-- 
          	...
          	<div class="ui-block-c">
          		<img id="img2" img alt="" src="../images/question_mark.png" border="0" borderColor="white" style="height: 150px; width: 110px; margin-top: 0em;" />
			...
			<div class="ui-block-d">
				<h5>
                 	...
                 	<image src="../images/delete.png" onclick="removeSecond()" class="ui-btn ui-shadow ui-corner-all ui-icon-plus ui-btn-icon-notext" style="left:43px; bottom:13px; width:20%;height:20%;"/>
                 	<!-- 
			...
			<%try 
					{
						...
						{	
							id1=Integer.parseInt(ProductDM.getProductBasedOnID(finalList.get(0)).getProductID()); %>
							 id="first_1" onclick="change('<%=ProductDM.getProductBasedOnID(finalList.get(0)).getImgRef()%>','#first_1','delBtn1','<%=ProductDM.getProductBasedOnID(finalList.get(0)).getProductName()%>','<%=ProductDM.getProductBasedOnID(finalList.get(0)).getPrice()%>',
			...
			<%try 
					{
						...
						%>
							  id="second_1" onclick="change('<%=ProductDM.getProductBasedOnID(finalList.get(1)).getImgRef()%>','#second_1','delBtn2','<%=ProductDM.getProductBasedOnID(finalList.get(1)).getProductName()%>','<%=ProductDM.getProductBasedOnID(finalList.get(1)).getPrice()%>',
			...
			<%try 
					{
						...
						%>
							  id="third_1" onclick="change('<%=ProductDM.getProductBasedOnID(finalList.get(2)).getImgRef()%>','#third_1','delBtn3','<%=ProductDM.getProductBasedOnID(finalList.get(2)).getProductName()%>','<%=ProductDM.getProductBasedOnID(finalList.get(2)).getPrice()%>',
			...
			<%try 
					{
						...
						%>
							 id="forth_1" onclick="change('<%=ProductDM.getProductBasedOnID(finalList.get(3)).getImgRef()%>','#forth_1','delBtn4','<%=ProductDM.getProductBasedOnID(finalList.get(3)).getProductName()%>','<%=ProductDM.getProductBasedOnID(finalList.get(3)).getPrice()%>',
			...
			<%try 
					{
						...
						%>
							 id="fifth_1" onclick="change('<%=ProductDM.getProductBasedOnID(finalList.get(4)).getImgRef()%>','#fifth_1','delBtn5','<%=ProductDM.getProductBasedOnID(finalList.get(4)).getProductName()%>','<%=ProductDM.getProductBasedOnID(finalList.get(4)).getPrice()%>',
			...
			<%try 
					{
						...
						%>
							id="sixth_1" onclick="change('<%=ProductDM.getProductBasedOnID(finalList.get(5)).getImgRef()%>','#sixth_1','delBtn6','<%=ProductDM.getProductBasedOnID(finalList.get(5)).getProductName()%>','<%=ProductDM.getProductBasedOnID(finalList.get(5)).getPrice()%>',
...
<div id="criButtons">
		<!-- Criteria buttons -->
  	 	...
  	 	<div style="font-size: 22pt;position:absolute;top:300px;left:110px" width="80px">
...
<tr>
  <td><div class="productAttributes" id="camprice1"></div></td>
